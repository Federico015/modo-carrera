const powerhouse = ['Inter Miami'];
const challenger = ['América', 'Tigres', 'Monterrey', 'Los Angeles FC', 'Seattle Sounders']
const midtable = ['CF Montreal', 'Chivas', 'Cruz Azul', 'New England Revolution', 'New York City', 'Pachuca',
'Philadelphia Union', 'Pumas']
const survival = []
