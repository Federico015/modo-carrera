...
function placeTeams(){
    ...
    for (i = 0; i < finalStandings.length; i++){
        ...
        if (i === 0){
            ...
            mundialDeClubes.textContent = 'Mundial de Clubes: ' + finalStandings[i-5][0] + ', ' + finalStandings[i-4][0] + ', '+ finalStandings[i-3][0] + ', ' + finalStandings[i-2][0] + ', ' + finalStandings[i-1][0] + ' y '+ finalStandings[i][0]+'.'
