const powerhouse = ['Al-Hilal', 'Al-Nassr', 'Al-Ittihad'];
const challenger = ['Al-Sadd', 'Urawa Red Diamonds', 'Al-Ain', 'Yokohama Marinos', 'Jeonbuk Hyundai Motors']
const midtable = ['Guangzhou Evergrande']
const survival = []
