const powerhouse = ['Boca Juniors', 'River Plate', 'Flamengo', 'Palmeiras', 'Atlético Mineiro']
const challenger = ['Defensa y Justicia', 'Estudiantes LP','Racing Club', 'San Lorenzo', 'Atlético Nacional',
'Internacional', 'Sao Paulo', 'Athletico Paranaense', 'Fluminense', 'Corinthians', 'Independiente']
const midtable = ['Talleres', 'Nacional', 'Peñarol', 'Ind. del Valle', 'Liga de Quito', 'Olimpia', 'Cerro Porteño',
'Colo Colo', 'Universidad de Chile', 'América de Cali']
const survival = []

const teams = powerhouse.concat(challenger).concat(midtable).concat(survival);

const matches = (teams.length - 1) * 2; 
