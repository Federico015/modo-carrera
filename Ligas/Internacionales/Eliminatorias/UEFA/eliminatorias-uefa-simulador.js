const powerhouse = ['Francia', 'Inglaterra'];
const challenger = ['Croacia', 'Alemania', 'España', 'Portugal', 'Bélgica', 'Italia', 'Países Bajos', 'Suiza']
const midtable = ['Rusia', 'Serbia', 'Dinamarca', 'Noruega', 'Polonia', 'Austria', 'República Checa', 'Suecia', 'Escocia', 'Ucrania']
const survival = ['Turquía', 'Albania', 'Gales', 'Hungría', 'Grecia', 'Irlanda', 'Irlanda del Norte', 'Finlandia', 'Islandia', 'Rumania', 'Macedonia del Norte',
'Eslovenia', 'Israel', 'Eslovaquia']
