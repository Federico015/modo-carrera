...
function placeTeams(){
    ...
    for (i = 0; i < finalStandings.length; i++){
        ...
        if (i === 0){
            ...
            mundialDeClubes.textContent = 'Mundial: '+ finalStandings[i-14][0] + ', ' + finalStandings[i-13][0] + ', '
            + finalStandings[i-12][0] + ', '+ finalStandings[i-11][0] + ', '+ finalStandings[i-10][0] + ', '+ finalStandings[i-9][0] + ', '
            + finalStandings[i-8][0] + ', ' + finalStandings[i-7][0] + ', ' + finalStandings[i-6][0] + ', '+ finalStandings[i-5][0] + ', '
            + finalStandings[i-4][0] + ', '+ finalStandings[i-3][0] + ', '  + finalStandings[i-2][0] + ', ' +  finalStandings[i-1][0]
            + ' y '+ finalStandings[i][0]+'.'
