const powerhouse = ['Senegal'];
const challenger = ['Argelia', 'Marruecos', 'Egipto', 'Camerún', 'Ghana', 'Nigeria', 'Túnez', 'Costa de Marfil']
const midtable = ['República del Congo', 'Guinea', 'Sudáfrica']
const survival = ['Burkina Faso', 'Malí', 'Gabón', 'Uganda']
