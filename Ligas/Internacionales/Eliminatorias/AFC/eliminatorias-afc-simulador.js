const powerhouse = ['Japón', 'Australia', 'Arabia Saudita', 'Corea del Sur'];
const challenger = ['Irán', 'Qatar']
const midtable = ['China', 'Emiratos Árabes Unidos', 'Irak']
const survival = ['Uzbekistán', 'Siria', 'Omán', 'Vietnam', 'Malasia']
