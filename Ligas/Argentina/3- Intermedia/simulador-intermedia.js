const powerhouse = []
const challenger = ['Almirante Brown', 'Brown de Adrogué', 'Defensores de Belgrano', 'Deportivo Madryn',
'Deportivo Maipú', 'Deportivo Riestra', 'Estudiantes (RC)', 'Gimnasia (Mza)', 'Güemes', 'Guillermo Brown (PM)', 
'Ind. Rivadavia', 'Mitre (SdE)', 'Racing (Córdoba)', 'Villa Dálmine']
const midtable = ['Alvarado', 'Deportivo Morón', 'Douglas Haig', 'Nueva Chicago', 'Olimpo']
const survival = ['Sp. Las Parejas']
