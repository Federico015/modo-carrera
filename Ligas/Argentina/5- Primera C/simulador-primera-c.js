const powerhouse = ['UAI Urquiza']
const challenger = ['Argentino de Rosario', 'Atlas', 'Berazategui', 'Cambaceres', 'Central Córdoba (R)', 
'Centro Español', 'Deportivo Español',  'Dock Sud', 'Excursionistas', 'Fénix', 'General Lamadrid', 'Juventud Unida',
'Laferrere', 'Leandro N. Alem', 'Liniers', 'Lugano', 'Luján', 'Muñiz', 'Real Pilar', 'San Martín (Burzaco)',
'Sportivo Italiano', 'Talleres (RdE)', 'Victoriano Arenas']
const midtable = ['Cañuelas', 'Central Ballester', 'Claypole', 'Club Mercedes', 'Deportivo Paraguayo', 'El Porvenir',
'Puerto Nuevo', 'San Miguel', 'Sportivo Barracas', 'Yupanqui']
const survival = []
