const powerhouse = ['Vélez Sarsfield']
const challenger = ['Agropecuario', 'Arsenal de Sarandí', 'Atlético de Rafaela', 'Barracas Central', 'Belgrano',
'Central Córdoba SdE', 'Chacarita', 'Ferro', 'Instituto', 'Patronato', 'Platense', 'Quilmes', 'San Martín (T)',
'Sarmiento (J)']
const midtable = ['Aldosivi', 'Almagro', 'Gimnasia Jujuy', 'San Martín (SJ)', 'San Telmo']
const survival = []
