const powerhouse = ['Villa Mitre'];
const challenger = ['Andino (LR)', 'Atenas (RC)', 'Atlético Paraná', 'Camioneros',  'Def. Pronunciamiento',
'Defensores (VR)', 'Desamparados', 'El Linqueño', 'Ferro (GP)', 'Germinal', 'Huracán Las Heras',
'Independiente (Ch)', 'Juventud Unida (ER)', 'Liniers (BB)', 'San Martín (Mza)', 'Sol de América', 'Tiro Federal']
const midtable = ['9 de Julio', 'Ben Hur', 'Boxing Club', 'CAI (Cro. Rivadavia', 'Ciudad Bolívar', 'Cuervos FDM',
'Deportivo Roca', 'Huracán (TA)', 'Independiente (Nqn)', 'Kimberley', 'San Lorenzo (Alem)', 'Sp. Peñarol (SJ)',
'Sportivo Baradero', 'Unión Aconquija', 'Unión (Villa Krause)']
const survival = ['El Silbido', 'Huracán (Corrientes', 'La Mona 44']
