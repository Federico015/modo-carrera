    ...
    for (i = 0; i < finalStandings.length; i++){
        ...
        if (i === 0){
            ...
            info.appendChild(winner)
                ...
                ascenso.textContent = 'Ascensos: ' + finalStandings[i-1][0] + ' y '+ finalStandings[i][0]+'.'
            ...
            relegated.textContent = 'Descensos: ' + finalStandings[i-2][0] + ', ' + finalStandings[i-1][0] + ' y '+ finalStandings[i][0]+'.'
