const powerhouse = ['Atlanta', 'Estudiantes (BA)']
const challenger = ['All Boys', 'Colegiales', 'Comunicaciones', 'Defensores Unidos', 'Flandria', 'Sacachispas',
'Temperley', 'Tristán Suárez']
const midtable = ['Acassuso', 'Deportivo Armenio', 'Deportivo Merlo', 'Ituzaingó', 'J.J. Urquiza', 'Los Andes', 'Midland']
const survival = ['Argentino de Merlo', 'Argentino de Quilmes', 'Villa San Carlos'];
