...
const challenger = ['Defensa y Justicia', 'Estudiantes LP','Racing Club', 'San Lorenzo', 'Talleres']
const midtable = ['Argentinos Juniors', 'Atlético Tucumán', 'Banfield', 'Colón', 'Gimnasia LP', 'Godoy Cruz',
'Independiente', 'Huracán', 'Lanús', 'Newell\'s', 'Rosario Central', 'Tigre', 'Unión']
const survival = []
