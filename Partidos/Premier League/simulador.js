...
let nivelPotencia = ['Arsenal', 'Liverpool', 'Manchester City'];
let nivelSuperior = ['Brighton', 'Chelsea', 'Manchester United', 'Newcastle United', 'Tottenham'];
let nivelNormal = ['Aston Villa', 'Crystal Palace', 'Everton', 'Fulham', 'Leicester City', 'West Ham', 'Wolverhampton'];
let nivelInferior = ['Bournemouth', 'Cardiff City', 'Sheffield United', 'Watford', 'West Bromwich'];
let nivelMinimo = [];
