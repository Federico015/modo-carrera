...
let nivelPotencia = ['Arsenal', 'Atlético Madrid', 'Barcelona', 'Bayern Munich', 'Inter', 'Liverpool', 'Manchester City', 
'Paris Saint-Germain', 'Real Madrid'];
let nivelSuperior = ['Bayer Leverkusen', 'Benfica', 'Borussia Dortmund', 'Eintracht Frankfurt', 'Juventus', 'Lyon', 'Manchester United',
'Milan', 'Porto', 'Roma'];
let nivelNormal = ['Aston Villa', 'Ajax', 'Brujas', 'Fenerbahce', 'Niza', 'PSV', 'Valencia'];
let nivelInferior = [ 'Anderlecht' ,'Besiktas', 'Celtic', 'Copenhague',  'Olympiakos', 'Shakhtar Donetsk', 'Young Boys', 'Zürich'];
let nivelMinimo = ['Ferencvaros', 'Sparta Praga'];
